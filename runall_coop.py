...
ssub_path = '/media/labs/rsmith/wellbeing/tasks/Cooperation/scripts/run_coop.ssub'
...
for subject in subjects:
    ...
    ###python3 runall_coop.py /media/labs/rsmith/lab-members/clavalley/studies/development/wellbeing/cooperation/round3mturk/id_list_1.csv /media/labs/NPC/DataSink/WBMTURK_Cooperation_TaskCB/ /media/labs/rsmith/wellbeing/tasks/Cooperation/output/ 1